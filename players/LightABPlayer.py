...
class Player(AbstractPlayer):
    def __init__(self, game_time, penalty_score):
        ...
        # heuristic weights
        self.weights = utils.get_weights(simple=0.6, rival_dist=0, closest_fruit=0,
                                         score_diff=0.4, fruits_taken=0)
